        ...
        <div class="container mx-auto px-4 max-w-4xl">
            ...
            <div class="flex flex-col md:flex-row items-center md:space-x-8">
                <div class="md:w-1/3 mb-8 md:mb-0">
                    <img src="https://placehold.co/300x300/e0e7ff/4338ca?text=Your+Photo" alt="Your Profile Photo" class="rounded-full shadow-xl mx-auto w-48 h-48 object-cover border-4 border-indigo-200">
                </div>
