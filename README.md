        ...
        <div class="container mx-auto px-4 max-w-4xl">
            ...
            <div class="flex flex-col md:flex-row items-center md:space-x-8">
                <div class="md:w-1/3 mb-8 md:mb-0">
                    <img src="<img src="3dee843a.png.pdf" alt="updated_image (1).png"rounded-full shadow-xl mx-auto w-48 h-48 object-cover border-4 border-indigo-200">"rounded-full shadow-xl mx-auto w-48 h-48 object-cover border-4 border-indigo-200">
                </div>
