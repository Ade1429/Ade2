        ...
        <div class="container mx-auto px-4 max-w-4xl">
            ...
            <div class="flex flex-col md:flex-row items-center md:space-x-8">
                <div class="md:w-1/3 mb-8 md:mb-0">
                    <img src="<img src="https://placehold.co/300x300/e0e7ff/4338ca?text=Your+Photo" alt="updated_image (1).png"rounded-full shadow-xl mx-auto w-48 h-48 object-cover border-4 border-indigo-200">"rounded-full shadow-xl mx-auto w-48 h-48 object-cover border-4 border-indigo-200">
                </div>
            ...
            <div class="bg-white p-8 rounded-lg shadow-md border border-gray-200">
                ...
                <div class="text-center mt-8 text-gray-600 text-sm">
                    ...
                    <div class="flex justify-center space-x-4 mt-2">
                        ...
                        <a href="mailto:"douze712@gmail.com class="cta-button">Email Me: douze712@gmail.com</a>
                </div>
            </div>
        </div>
    </section>
